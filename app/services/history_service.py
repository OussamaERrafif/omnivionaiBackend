...
class _UnconfiguredSupabaseClient:
    """Defers a missing optional Supabase configuration until a history route is used."""

    def __getattr__(self, _: str):
        raise RuntimeError(
            "SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY are required for search history."
        )
